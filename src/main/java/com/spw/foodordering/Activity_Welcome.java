...
import com.spw.foodordering.application.FoodOrderingApplication;
import com.spw.foodordering.control.BaseActivity;
import com.spw.foodordering.tools.MobileInfo;
import com.spw.foodordering.tools.NetWorkTool;
...
public class Activity_Welcome extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        versionNumber.setText("页面加载中，请稍后..." /*+ getLocalVersionName(Activity_Welcome.this)*/);
    ...
    Runnable runnableupdate = new Runnable() {
        public void run() {
            // 更新菜单文件
//            String foodListStr = PostUtility.postFoodList("76169191");
//            Log.i("Activity_Welcome",foodListStr);
